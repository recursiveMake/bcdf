    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(to='website.GalleryArticle')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_campaign', models.OneToOneField(null=True, blank=True, to='website.BannerCampaign')),
                ('educational_article', models.OneToOneField(null=True, blank=True, to='website.EducationalArticle')),
                ('home_page_campaign', models.OneToOneField(null=True, blank=True, to='website.HomePageCampaign')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt', models.CharField(max_length=64, blank=True)),
                ('educational_article', models.ForeignKey(blank=True, to='website.EducationalArticle', null=True)),
                ('special_article', models.ForeignKey(blank=True, to='website.SpecialArticle', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educational_article', models.OneToOneField(null=True, blank=True, to='website.EducationalArticle')),
                ('gallery_article', models.OneToOneField(null=True, blank=True, to='website.GalleryArticle')),
                ('news_article', models.OneToOneField(null=True, blank=True, to='website.NewsArticle')),
                ('newsletter', models.OneToOneField(null=True, blank=True, to='website.NewsLetter')),
                ('special_article', models.OneToOneField(null=True, blank=True, to='website.SpecialArticle')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='image',
            name='news_article',
            field=models.OneToOneField(null=True, blank=True, to='website.NewsArticle'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='image',
            name='special_article',
            field=models.OneToOneField(null=True, blank=True, to='website.SpecialArticle'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlefile',
            name='educational_article',
            field=models.ForeignKey(blank=True, to='website.EducationalArticle', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlefile',
            name='news_article',
            field=models.ForeignKey(blank=True, to='website.NewsArticle', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlefile',
            name='special_article',
            field=models.ForeignKey(blank=True, to='website.SpecialArticle', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlecontent',
            name='educational_article',
            field=models.OneToOneField(null=True, blank=True, to='website.EducationalArticle'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlecontent',
            name='gallery_article',
            field=models.OneToOneField(null=True, blank=True, to='website.GalleryArticle'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='articlecontent',
